...
parser.add_argument('--input', type=str, default='mb1-ssd-Epoch-1709-Loss-0.8591486492058199.pth', help="path to input PyTorch model (.pth checkpoint)")
parser.add_argument('--output', type=str, default='Epoch-1709.onnx', help="desired path of converted ONNX model (default: <NET>.onnx)")
